      ...
      <div className="footer-parent">
        <div className="footer-part1">
          <div className="logo-div">
            {/* <img src={logo} alt="" /> */}
            <h1 style={{fontStyle:'italic'}}>Masai<span style={{background:'#fff', color:'#333', borderRadius:'5px', paddingRight: '5px', paddingLeft: '5px'}}>Forum</span></h1>
          </div>
          {/* <div>
            <p>
